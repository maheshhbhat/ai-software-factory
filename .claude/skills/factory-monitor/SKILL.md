...
terminal verdict, and whether the harness stopped its poller. An active span is
`STUCK` when its latest heartbeat is older than fifteen seconds. Do not call a
